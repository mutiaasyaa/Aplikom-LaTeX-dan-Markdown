...
\end{eulercomment}
\eulerimg{23}{images/EMT First Steps - 22305144024-004.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulerprompt}
>alas=5; tinggi=22; 0.5*alas*tinggi
\end{eulerprompt}
\begin{euleroutput}
  55
\end{euleroutput}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT First Steps - 22305144024-008-large.png}
\begin{eulerprompt}
>$&solve(a*x^2+b*x+c,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT First Steps - 22305144024-011-large.png}
...
\end{eulercomment}
\eulersubheading{Soal Matematika}
\begin{eulercomment}
1. Sebuah kota kecil dengan penduduk 1000 orang terkena suatu wabah
penyakit menular. Jumlah orang yang sakit setelah t hari semenjak
menyebarnya wabah penyakit dapat dimodelkan dengan fungsi berikut:\\
\end{eulercomment}
\begin{eulerformula}
\[
P(t) = \frac{1000}{(1 + 999 \times exp(-0.603 \times 10))}
\]
\end{eulerformula}
\begin{eulercomment}
Penyelesaian :\\
Mengacu pada formula di atas, jumlah penduduk yang sakit 10 hari
setelah menyebarnya penyakit dapat diestimasi sebagai berikut
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Diperoleh jumlah orang yang sakit semenjak 10 hari menyebarnya wabah
penyakit adalah 294 orang.

2. Apabila pertumbuhan populasi penduduk dianggap bertambah secara
eksponensial maka jumlah penduduk awal suatu tahun tertentu dapat
dihitung dengan formula:\\
\end{eulercomment}
\begin{eulerformula}
\[
y = y0 \times exp(k\times t)
\]
\end{eulerformula}
\begin{eulercomment}
dimana y adalah jumlah penduduk pada awal tahun acuan, k adalah laju
pertambahan penduduk dan t adalah perbedaan waktu terhadap tahun acuan

Penyelesaian:\\
Misalkan jumlah penduduk dunia pada awal tahun 1990 adalah sekitar 5,3
milyar dengan laju pertambahan penduduk sekitar 2\% per tahun. Maka
perkiraan penduduk dunia pada awal tahun 2015 adalah sebagai berikut
\end{eulercomment}
\begin{eulerprompt}
>y0=5.3; //jumlah penduduk pada awal tahun 1990 (milyar)
>k=0.02; // laju pertumbuhan pertahun
>t=2015-1990; // selang waktu sejak awal tahun 1990 (tahun)
>y=y0*exp(k*t) // jumlah penduduk pada awal tahun 2015 (milyar)
\end{eulerprompt}
\begin{euleroutput}
  8.73822273471
\end{euleroutput}
\begin{eulercomment}
Jadi, jumlah penduduk dunia pada awal tahun 2015 adalah sebanyak 8,73
milyar.\\
\end{eulercomment}
\eulersubheading{}
