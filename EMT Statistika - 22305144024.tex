...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-016.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-018.png}
\begin{eulercomment}
Tentukan beberapa warna untuk masing-masing bagian.
\end{eulercomment}
\begin{eulerprompt}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-020.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-021.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-029.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-033.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-037.png}
\begin{eulercomment}
Berikut ini adalah plot kotak dari kedua usia tersebut. Ini hanya
menunjukkan, bahwa usia keduanya berbeda.
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-041.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-042.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-043.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-044.png}
\begin{eulercomment}
Menghapus data.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  pi = 3.14159265359
\end{euleroutput}
\eulerheading{Pengindeksan (Indexing)}
\begin{eulercomment}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-047.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-048.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
It would also be possible to read all numbers in that file with
getvector().
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Seorang pelatih panah ingin mengevaluasi nilai ketangkasan 6 anak
didiknya dengan jarak 250 meter dan masing-masing mendapat nilai
87,78,76,75,90,92.

Berapakah rata-rata nilai ketangkasan 6 anak tersebut?

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>x=[87,78,76,75,90,92]; mean(x),
\end{eulerprompt}
\begin{euleroutput}
  83
\end{euleroutput}
...
\end{eulerformula}
\begin{eulercomment}
Dengan demikian, rata-rata nilai ketangkasan 6 anak didiknya adalah
83.
\end{eulercomment}
\begin{eulercomment}
...
\begin{eulercomment}
Berikut adalah data hasil dari pengukuran berat badan (BB) 35 siswa SD
Negeri Banguntapan.\\
Dari ke 35 siswa, mayoritas siswa memiliki berat badan yang ideal.\\
Siswa yang mempunyai BB dalam rentang 21-25 kg sebanyak 3 orang,\\
Siswa yang mempunyai BB dalam rentang 26-30 kg sebanyak 11 orang,\\
Siswa yang mempunyai BB dalam rentang 31-35 kg sebanyak 6 orang,\\
Siswa yang mempunyai BB dalam rentang 36-40 kg sebanyak 7 orang,\\
Siswa yang mempunyai BB dalam rentang 41-45 kg sebanyak 4 orang,\\
Siswa yang mempunyai BB dalam rentang 46-50 kg sebanyak 4 orang.

Tentukan modus dari data hasil pengukuran berat badan 35 siswa di SD
tersebut!

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>21-0.5 // Menentukan tepi bawah kelas yang terkecil
\end{eulerprompt}
\begin{euleroutput}
  20.5
\end{euleroutput}
\begin{eulerprompt}
>(25-21)+1 // Menentukan panjang kelas
\end{eulerprompt}
\begin{euleroutput}
  5
\end{euleroutput}
\begin{eulerprompt}
>50+0.5 // Menentukan tepi atas yang terbesar
\end{eulerprompt}
\begin{euleroutput}
  50.5
\end{euleroutput}
\begin{eulerprompt}
>r=20.5:5:50.5; v=[3,11,6,7,4,4];
...
\end{euleroutput}
\begin{eulercomment}
Berdasarkan data, modus berada pada kelas 25.5-30.5.
\end{eulercomment}
\begin{eulerprompt}
>Tb=25.5, p=5, d1=1, d2=3
\end{eulerprompt}
\begin{euleroutput}
  25.5
  5
...
\end{euleroutput}
\begin{eulercomment}
Dengan demikian, modus dari data hasil pengukuran berat badan 35 siswa
di SDN Banguntapan adalah 26.75.
\end{eulercomment}
\begin{eulercomment}
...
\begin{eulercomment}
Berikut adalah data hasil dari pengukuran berat badan 50 siswa SDN
Banguntapan.\\
Dari ke 50 siswa, mayoritas siswa memiliki berat badan yang ideal.\\
Siswa yang mempunyai berat badan dalam rentang 21-26 kg sebanyak 2
orang,\\
Siswa yang mempunyai berat badan dalam rentang 27-32 kg sebanyak 7
orang,\\
Siswa yang mempunyai berat badan dalam rentang 33-38 kg sebanyak 14
orang,\\
Siswa yang mempunyai berat badan dalam rentang 39-44 kg sebanyak 12
orang,\\
Siswa yang mempunyai berat badan dalam rentang 45-50 kg sebanyak 10
orang,\\
Siswa yang mempunyai berat badan dalam rentang 51-56 kg sebanyak 5
orang.

Tentukan median dari data hasil pengukuran berat badan 50 siswa di SD
tersebut!
...
\end{euleroutput}
\begin{eulerprompt}
>56+0.5 // Menentukan tepi atas kelas yang terbesar
\end{eulerprompt}
\begin{euleroutput}
  56.5
\end{euleroutput}
\begin{eulerprompt}
>r=20.5:6:56.5; v=[2,7,14,12,10,5];
>T:=r[1:6]' | r[2:7]' | v'; writetable(T,labc=["TB","TA","frek"])
\end{eulerprompt}
\begin{euleroutput}
          TB        TA      frek
...
pada kelas 38.5-44.5.
\end{eulercomment}
\begin{eulerprompt}
>Tb=38.5, p=6, n=50, Fks=15, fm=12
\end{eulerprompt}
\begin{euleroutput}
  38.5
  6
...
\begin{eulerformula}
\[
Me = 38.5+\frac{\frac{1}{2}({50})-15}{12}.{6}
\]
\end{eulerformula}
\begin{eulerformula}
\[
...
\end{eulerformula}
\begin{eulercomment}
Dengan demikian, median dari data hasil pengukuran berat badan 50
siswa SDN Banguntapan adalah 43.5
\end{eulercomment}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>data=[15,17,10,12,13,20,15,15];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [10,  12,  13,  15,  15,  15,  17,  20]
\end{euleroutput}
\begin{eulerprompt}
>median(data)
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Dengan demikian, nilai median pada data upah 8 karyawan adalah 15.
\end{eulercomment}
\begin{eulercomment}
...
Persamaan Diferensial 13 mahasiswa sebagai berikut:
85,90,80,95,50,75,55,60,65,75,90,90,95.
...
\end{eulercomment}
\begin{eulerprompt}
>data=[85,90,80,95,50,75,55,60,65,75,90,90,95]
\end{eulerprompt}
\begin{euleroutput}
  [85,  90,  80,  95,  50,  75,  55,  60,  65,  75,  90,  90,  95]
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  [50,  55,  60,  65,  75,  75,  80,  85,  90,  90,  90,  95,  95]
\end{euleroutput}
\begin{eulerprompt}
>median(data)
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Jadi nilai median dari data hasil Ujian Akhir Semester mata kuliah
Persamaan Diferensial 13 mahasiswa adalah 80.
\end{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  0.8286736004228034,0.121933791490445,0.2452551917390392
  0.9075876507651761,0.08391903859242716,0.6413545410684943
  0.993273993687839,0.805526574826687,0.6448847054574638
...
\end{eulerprompt}
\begin{euleroutput}
    0.82867   0.12193   0.24526 
    0.90759  0.083919   0.64135 
    0.99327   0.80553   0.64488 
\end{euleroutput}
\begin{eulerprompt}
>mean(V),
\end{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  0.3491688434404096,0.7398845366622254,0.8226563357402517,0.3728495974523089
  0.6209769215355806,0.906401213279042,0.2737868429496333,0.03457116705297921
  0.3357303312686636,0.5780511177770538,0.849418085627508,0.9486955747190509
  0.2962412914170464,0.8492752044407615,0.368272695365911,0.2994847886526059
...
\end{eulerprompt}
\begin{euleroutput}
    0.34917   0.73988   0.82266   0.37285 
    0.62098    0.9064   0.27379  0.034571 
    0.33573   0.57805   0.84942    0.9487 
    0.29624   0.84928   0.36827   0.29948 
\end{euleroutput}
\begin{eulerprompt}
>mean(V[1])
\end{eulerprompt}
...
\begin{eulercomment}
Data berikut menunjukkan nilai yang diperoleh 50 siswa SMP 1
Sungailiat pada Ujian Nasional mata pelajaran matematika.\\
Siswa yang mendapat nilai dalam rentang 61-65 sebanyak 4 orang,\\
Siswa yang mendapat nilai dalam rentang 66-70 sebanyak 9 orang,\\
Siswa yang mendapat nilai dalam rentang 71-75 sebanyak 12 orang,\\
Siswa yang mendapat nilai dalam rentang 76-80 sebanyak 10 orang,\\
Siswa yang mendapat nilai dalam rentang 81-85 sebanyak 8 orang,\\
Siswa yang mendapat nilai dalam rentang 86-90 sebanyak 5 orang,\\
Siswa yang mendapat nilai dalam rentang 91-95 sebanyak 2 orang.
...
\end{eulercomment}
\begin{eulerprompt}
>61-0.5 // Menentukan tepi bawah kelas yang terkecil
\end{eulerprompt}
\begin{euleroutput}
  60.5
\end{euleroutput}
\begin{eulerprompt}
>(65-61)+1 // Menentukan panjang kelas
\end{eulerprompt}
\begin{euleroutput}
  5
\end{euleroutput}
\begin{eulerprompt}
>95+0.5 // Menentukan tepi atas kelas yang terbesar
\end{eulerprompt}
\begin{euleroutput}
  95.5
\end{euleroutput}
\begin{eulerprompt}
>r=60.5:5:95.5; v=[4,9,12,10,8,5,2];
...
\end{euleroutput}
\begin{eulerprompt}
>(T[,1]+T[,2])/2 // Menentukan titik tengah
\end{eulerprompt}
\begin{euleroutput}
         63 
         68 
...
\begin{eulerformula}
\[
\sum t_i f_i=(4)(63)+(9)(68)+(12)(73)+(10)(78)+(8)(83)+(5)(88)+(2)(93)=3.990
\]
\end{eulerformula}
\begin{eulerformula}
\[
\sum f_i=4+9+12+10+8+5+2=50
\]
\end{eulerformula}
\begin{eulerformula}
\[
...
\end{eulerformula}
\begin{eulercomment}
Penyajian data dalam bentuk histogram dari data tersebut
\end{eulercomment}
\begin{eulerprompt}
>plot2d(r,v,a=60,b=95,c=0,d=20,bar=1,color=red,style="\(\backslash\)"):
\end{eulerprompt}
\eulerimg{13}{images/EMT Statistika - 22305144024-073.png}
\begin{eulercomment}
Dengan demikian, rata-rata dari data tersebut adalah 79,8.
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Latihan 9}
\begin{eulercomment}
Diberikan data berat sapi di suatu peternakan yang memelihara 50 sapi.\\
Sapi dengan berat 45kg terdapat 11 ekor,\\
Sapi dengan berat 46kg terdapat 9 ekor,\\
Sapi dengan berat 47kg terdapat 5 ekor,\\
Sapi dengan berat 48kg terdapat 10 ekor,\\
Sapi dengan berat 49kg terdapat 7 ekor,\\
Sapi dengan berat 50kg terdapat 8 ekor.

Tentukan rata-rata berat sapi di peternakan tersebut.

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>x=[45,46,47,48,49,50], f=[11,9,5,10,7,8] // Mendefinisikan data dan frekuensi
\end{eulerprompt}
\begin{euleroutput}
  [45,  46,  47,  48,  49,  50]
  [11,  9,  5,  10,  7,  8]
\end{euleroutput}
\begin{eulerprompt}
>mean(x,f) // Menghitung mean
\end{eulerprompt}
\begin{euleroutput}
  47.34
\end{euleroutput}
\begin{eulercomment}
Dengan demikian, rata-rata berat sapi di peternakan tersebut adalah
47.34.
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Latihan 10}
\begin{eulercomment}
Banyaknya pengajar di 5 bimbel secara berturut-turut adalah 6,8,7,5,6
Dengan memandang data itu sebagai data populasi, hitunglah nilai
rata-rata banyaknya pengajar di 5 bimbel tersebut!
...
\end{eulerformula}
\begin{eulercomment}
Dengan demikian, nilai rata-rata banyaknya pengajar di 5 bimbel
tersebut adalah 6.4.
\end{eulercomment}
\end{eulernotebook}
\end{document}
