...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-003.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-004.png}
\eulersubheading{}
\begin{eulercomment}
2. Gambar segitiga dengan titik-titik sudut ketiga titik singgung
tersebut. Merupakan segitiga apakah itu?
...
>plotSegment(A,C,"b"): // b=AC
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-005.png}
\begin{eulercomment}
...
>D=lineIntersection(h,lineThrough(B,C)); plotPoint(D,value=1); color(2);
>plotSegment(A,D):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-007.png}
\begin{eulerprompt}
>n=angleBisector(A,B,C);
>color(5); plotLine(n); color(1);
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-008.png}
\eulersubheading{}
\begin{eulercomment}
5. Gambar jari-jari lingkaran dalam.
...
\end{euleroutput}
\begin{eulerprompt}
>color(3); plotSegment(P,s,"r"):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-009.png}
\eulersubheading{}
\begin{eulercomment}
6. Hitung luas lingkaran luar dan luas lingkaran dalam segitiga ABC.
Adakah hubungan antara luas kedua lingkaran tersebut dengan luas
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-010.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-012-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-014-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-020-large.png}
\begin{eulerprompt}
...
\end{eulercomment}
\begin{eulerprompt}
>A &:= [1,0]; c=circleWithCenter(A,4); color(2);
>B &:= [1,2]; C &:= [2,1]; l=lineThrough(B,C); color(4);
>setPlotRange(5); plotCircle(c); plotLine(l); color(12);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>\{P1,P2,f\}=lineCircleIntersections(l,c); color(2);
>P1, P2, f
\end{eulerprompt}
\begin{euleroutput}
  [4.64575,  -1.64575]
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-024.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-026.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-031.png}
\begin{eulerprompt}
>remvalue x,y,a,b,c
...
\end{eulerprompt}
\eulerimg{16}{images/EMT Geometri - 22305144024-035.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT Geometri - 22305144024-039-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-040.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-046-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-052.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-056-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-064.png}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>color(2); plotCircle(LD()):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-069.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-072.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-075-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-078-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-079.png}
\begin{eulercomment}
Tentu,
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-084-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-088.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-091-large.png}
\eulerimg{0}{images/EMT Geometri - 22305144024-092-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-095-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometri - 22305144024-103-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometri - 22305144024-107-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-109.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT Geometri - 22305144024-111-large.png}
\eulerimg{1}{images/EMT Geometri - 22305144024-112-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-114.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-125.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-126.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-128.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-130.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-132.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-133.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-134.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-138.png}
...
>povend();
\end{eulerprompt}
\eulerimg{26}{images/EMT Geometri - 22305144024-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT Geometri - 22305144024-140.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-142.png}
...
>plotSegment(D,A,""):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-143.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
>g=angleBisector(D,A,B);
>color(2); plotLine(l,""); plotLine(g,""); color(1):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-144.png}
\begin{eulerprompt}
>r=norm(A-C)/2
\end{eulerprompt}
\begin{euleroutput}
...
>plotCircle(c,"Lingkaran dalam segi-4"); color (4):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-145.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-146.png}
\begin{eulerprompt}
>sol &= solve([4*a-2*b+c=-2,4*a+2*b+c=-2,c=1],[a,b,c])
\end{eulerprompt}
\begin{euleroutput}
...
\end{euleroutput}
\begin{eulerprompt}
>plot2d("(-3/4)*(x^2)-0*x+1");
>plotPoint(P,"P"); plotPoint(Q,"Q"); plotPoint(R,"R"):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-147.png}
\eulersubheading{}
\begin{eulercomment}
...
>plotSegment(D,A,""):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-148.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-149.png}
\begin{eulerprompt}
>r=norm(P-projectToLine(P,lineThrough(A,B)))
\end{eulerprompt}
\begin{euleroutput}
...
\end{euleroutput}
\begin{eulerprompt}
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segiempat ABCD"); color(2):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-150.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-151.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-4,xmax=4,ymin=-3,ymax=3):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-152.png}
\begin{eulerprompt}
>plot2d("abs(x+2)+abs(x-2)", xmin=-5, xmax=5):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-153.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-5,xmax=5,ymin=-3,ymax=3,hue=1):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-154.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-4,xmax=4,ymin=-3,ymax=3):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-155.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-4,xmax=4):
\end{eulerprompt}
\eulerimg{25}{images/EMT Geometri - 22305144024-156.png}
